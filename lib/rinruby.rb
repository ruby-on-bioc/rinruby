...
class RinRuby
  ...
  require_relative 'rinruby/r_data_type'
  require_relative 'rinruby/r_integer'
  require_relative 'rinruby/r_double'
  require_relative 'rinruby/r_logical'
  require_relative 'rinruby/r_character'
  require_relative 'rinruby/version'
